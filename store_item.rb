...
puts "The store only has this fruit: #{store_fruit[:type]} and it costs: $#{store_fruit[:price]} "
puts "The store only has type of meat: #{store_meat[:type]} and it costs: $#{store_meat[:price]} "
